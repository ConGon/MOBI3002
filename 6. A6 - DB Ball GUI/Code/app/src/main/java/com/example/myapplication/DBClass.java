...
public class DBClass extends SQLiteOpenHelper implements DB_Interface {
    ...
    private static final String _COL_1 = "POSITIONX";  // Names of the columns
    private static final String _COL_2 = "POSITIONY";
    private static final String _COL_3 = "SIZEX";
    private static final String _COL_4 = "SIZEY";
    private static final String _COL_5 = "SPEEDX";
    private static final String _COL_6 = "SPEEDY";
...
//                "(283.0, 222.9, 0.5, 4.7)");
    ...
    public int save(DataModel dataModel) {
        ...
        values.put(_COL_1, dataModel.getPositionX());
        values.put(_COL_2, dataModel.getPositionY());
        values.put(_COL_3, dataModel.getSizeX());
        values.put(_COL_4, dataModel.getSizeY());
        values.put(_COL_5, dataModel.getSpeedX());
        values.put(_COL_6, dataModel.getSpeedY());
...
//    }
    ...
    public List<DataModel> findAll() {
        ...
        if (cursor.moveToFirst()) {
            do {
                item = new DataModel(cursor.getInt(0), cursor.getFloat(1), cursor.getFloat(2), cursor.getFloat(3), cursor.getFloat(4) , cursor.getFloat(5), cursor.getFloat(6));
                temp.add(item);
